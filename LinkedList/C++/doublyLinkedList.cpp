...
struct node *middleOfList(struct node *begin);
...
int main()
{
	...
	while (1)
	{
		...
		cout << "9.Middle Of Doubly Linked List\n";
		cout << "10.Reverse the Doubly Linked List\n";
		cout << "11.Exit\n";
		...
		case 8:
			...
			break;
		case 9: {
			struct node* middleNode = middleOfList(begin);
			cout << "Middle Element: " << middleNode->info;
			break;
		}
		case 10:
...
// BY turtle-tortoise algorithm aks Floyd's cycle-finding algorithm
struct node *middleOfList(struct node *begin)
{
	if (begin == NULL)
	{
